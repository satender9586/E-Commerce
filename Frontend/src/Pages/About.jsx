    ...
    return (
        <Layout>
            <Box p={"0 5%"} pb={"2rem"} bgGradient="linear(to bottom, #142850, #000000)">
                <Box py={"2rem"}>
                    <Text fontSize={"35px"} fontWeight={"700"} color={"green"}>About  <spna style={{ color: "red" }}>The Test of Fast-Food </spna> </Text>
                    ...
                    <Text fontSize={"30px"} fontWeight={"500"} color={"blue"}>Goal</Text>
                    ...
                    <Text fontSize={"30px"} fontWeight={"500"} color={"blue"}>Purpose</Text>
                ...
                <Box mt={"0.5rem"} >
                    <Text fontSize={"35px"} fontWeight={"500"} color={"green"}>Our Team & Members</Text>
